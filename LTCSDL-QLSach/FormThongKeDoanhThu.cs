...
namespace LTCSDL_QLSach
{
    public partial class FormThongKeDoanhThu : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'qLBanSachDataSet.ThanhToan' table. You can move, or remove it, as needed.
            this.thanhToanTableAdapter.Fill(this.qLBanSachDataSet.ThanhToan);
            ...
            using (SaveFileDialog ofd = new SaveFileDialog() { Filter = "Excel WorkBook|*.xlsx", ValidateNames = true })
            {
                if (ofd.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        ...
                        {
                            workbook.Worksheets.Add(this.qLBanSachDataSet.ThanhToan.CopyToDataTable(), "Thông Kê Doanh Thu");
