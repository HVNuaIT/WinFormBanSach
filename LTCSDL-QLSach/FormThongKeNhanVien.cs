...
namespace LTCSDL_QLSach.Admin
{
    public partial class FormThongKeNhanVien : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'qLBanSachDataSet1.User' table. You can move, or remove it, as needed.
            this.userTableAdapter.Fill(this.qLBanSachDataSet1.User);
            ...
            using (SaveFileDialog ofd = new SaveFileDialog() { Filter = "Excel WorkBook|*.xlsx", ValidateNames = true })
            {
                if (ofd.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        ...
                        {
                            workbook.Worksheets.Add(this.qLBanSachDataSet1.User.CopyToDataTable(), "Thông Kê Doanh Thu");
